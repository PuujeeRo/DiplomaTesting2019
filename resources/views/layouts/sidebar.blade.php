  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li><a href="{{ url('employee-management') }}"><i class="fa fa-link"></i> <span>Project Management</span></a></li>
        <li class="{{Request::is('admin-management') ? 'active' : ''}}"><a href="{{ route('admin-management.index') }}"><i class="fa fa-link"></i> <span>Admin management</span></a></li>
